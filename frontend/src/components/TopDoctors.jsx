      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-wrap gap-10 justify-center">
          {doctors.slice(0, 10).map((doctor, index) => (
            <div
              key={index}
              className="group w-[240px] h-[360px] bg-white rounded-2xl shadow-lg transition-transform duration-300 transform hover:-translate-y-3 hover:shadow-2xl flex flex-col overflow-hidden border border-gray-200"
            >
              {/* Image Container */}
              ...
              <div className="flex-grow p-5 flex flex-col justify-between">
                ...
                <button className="mt-3 py-3 px-4 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors duration-300 shadow-md hover:shadow-lg">
                  Book Appointment
                </button>
              </div>
            </div>
