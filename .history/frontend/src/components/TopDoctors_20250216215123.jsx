      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-wrap gap-10 justify-center">
          {doctors.slice(0, 10).map((doctor, index) => (
            <div
              key={index}
              className="group w-[210px] h-[270px] bg-white rounded-2xl shadow-lg transition-transform duration-300 transform hover:-translate-y-3 hover:shadow-2xl flex flex-col overflow-hidden border border-gray-200"
            >
              {/* Image Container */}
